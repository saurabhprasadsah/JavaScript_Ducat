...
// let {firstName:fname,lastName, age, test = "test"} = object;

// console.log(fname,lastName, age, test);

// let {firstName, ...t} = object;

// console.log(firstName, t);
...
// // Date.parse()
// console.log(Date.parse("10-10-2022")/1000/60/60/24/30/12);

// let strDate = new Date("12-10-2022 12:12:12")
